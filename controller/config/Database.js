...
const pool = mysql.createPool({
  ...
  host: "10.200.1.6", // Ganti dengan host database Anda
  // host: "192.168.7.2",
  user: "user_rsud", // Ganti dengan username database Anda
  // user: "oqpunya", // Ganti dengan username database Anda
  password: "54m4Rind4", // Ganti dengan password database Anda
  // password: "123456", // Ganti dengan password database Anda
  database: "app_rs", // Ganti dengan nama database Anda
